...
* I'm imagining an end product map that has a boundary running very roughly SSE-NNW like Niven's line. If you're plotting contiguous areas up to an arbitrary size, there are millions of possible ways of doing it, and it matters a lot where you start. So does that mean I should start off in central London, or at Greenwich, or at the eastern tip of Kent? I might be able to run a few different programs with different starting points and see what happens.
